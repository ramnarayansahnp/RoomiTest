function getCalendarDivString(a)
{
	...
	b+='<div class="ndp-corner-all ndp-header">',b+='<a href="javascript:void(0)" id="prev" title="Previous Month" class="ndp-prev"></a>',
	b+='<a href="javascript:void(0)" id="next" title="Next Month" class="ndp-next"></a>',
	b+='<span id="currentMonth"></span>',
	b+="</div>",b+='<div id="npd-table-div">',
	b+="<table>",b+='<tr class="ndp-days">',
	b+="<th>\u0906</th>",b+="<th>\u0938\u094b</th>",
	b+="<th>\u092e\u0902</th>",
	b+="<th>\u092c\u0941</th>",
	b+="<th>\u092c\u093f</th>",
	b+="<th>\u0936\u0941</th>",
...
function showNdpCalendarBox(a){
	...
	$("#ndp-nepali-box").css("left",c.left),showCalendar(b),npdCalendarVisible=!0}}
